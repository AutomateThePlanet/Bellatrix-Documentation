...
------------------
1. Download BELLATRIX UI Installer [**x86 version**](installers/Bellatrix.Installer.UI-1.2.8.0-x86.msi) or [**x64 version**](installers/Bellatrix.Installer.UI-1.2.8.0-x64.msi)
